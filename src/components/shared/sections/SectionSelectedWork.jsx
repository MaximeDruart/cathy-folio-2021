      ...
      a {
        ...
        .work_content {
          ...
          &.work_1 {
            ...
            margin-right: 20px;
            &.twitch {
              background-image: url("src/assets/img/designer.jpg");
            }
            &.work {
              background-image: url("src/assets/img/works/pxp/girl.jpg");
            }
          }
          &.work_2 {
            width: 32vw;
            ...
            &.work {
              background-image: url("src/assets/img/works/pxp/couv.jpg");
            }
          }
          &.work_3 {
            width: 14vw;
            ...
            &.work {
              background-image: url("src/assets/img/works/grissini/cover.jpg");
            }
          }
        }
      }
